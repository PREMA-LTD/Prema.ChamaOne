...
namespace Prema.ChamaOne.Infrastructure.Migrations
{
    ...
    [Migration("20240910064144_changed_decimal_points_again")]
    partial class changed_decimal_points_again
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Prema.ChamaOne.Infrastructure.Models.Contribution", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Prema.ChamaOne.Infrastructure.Models.Gender", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Prema.ChamaOne.Infrastructure.Models.Loan", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Prema.ChamaOne.Infrastructure.Models.Location.County", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Prema.ChamaOne.Infrastructure.Models.Location.Subcounty", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Prema.ChamaOne.Infrastructure.Models.Location.Ward", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Prema.ChamaOne.Infrastructure.Models.Member", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("fk_occupation_id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Prema.ChamaOne.Infrastructure.Models.MemberType", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Prema.ChamaOne.Infrastructure.Models.Occupation", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Prema.ChamaOne.Infrastructure.Models.SMSFailure", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Prema.ChamaOne.Infrastructure.Models.SMSRecord", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Prema.ChamaOne.Infrastructure.Models.Transaction", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("date_of_record")
                        .HasColumnType("datetime(6)");
            ...
            modelBuilder.Entity("Prema.ChamaOne.Infrastructure.Models.TransactionEntity", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Prema.ChamaOne.Infrastructure.Models.TransactionEntityType", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Prema.ChamaOne.Infrastructure.Models.TransactionStatus", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Prema.ChamaOne.Infrastructure.Models.TransactionType", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Prema.ChamaOne.Infrastructure.Models.Contribution", b =>
                {
                    b.HasOne("Prema.ChamaOne.Infrastructure.Models.Member", "Member")
                        .WithMany("Contributions")
                        .HasForeignKey("fk_member_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Prema.ChamaOne.Infrastructure.Models.TransactionStatus", "TransactionStatus")
                        .WithMany("Contributions")
            ...
            modelBuilder.Entity("Prema.ChamaOne.Infrastructure.Models.Location.Subcounty", b =>
                {
                    b.HasOne("Prema.ChamaOne.Infrastructure.Models.Location.County", "County")
            ...
            modelBuilder.Entity("Prema.ChamaOne.Infrastructure.Models.Location.Ward", b =>
                {
                    b.HasOne("Prema.ChamaOne.Infrastructure.Models.Location.Subcounty", "Subcounty")
                        .WithMany("Wards")
            ...
            modelBuilder.Entity("Prema.ChamaOne.Infrastructure.Models.Member", b =>
                {
                    b.HasOne("Prema.ChamaOne.Infrastructure.Models.Gender", "Gender")
                        .WithMany("Members")
                        .HasForeignKey("fk_gender_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Prema.ChamaOne.Infrastructure.Models.MemberType", "MemberType")
                        .WithMany("Members")
                        .HasForeignKey("fk_member_type_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Prema.ChamaOne.Infrastructure.Models.Occupation", "Occupation")
                        .WithMany("Members")
                        .HasForeignKey("fk_occupation_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Prema.ChamaOne.Infrastructure.Models.Location.Ward", "Ward")
                        .WithMany("Members")
            ...
            modelBuilder.Entity("Prema.ChamaOne.Infrastructure.Models.SMSFailure", b =>
                {
                    b.HasOne("Prema.ChamaOne.Infrastructure.Models.SMSRecord", "SMSRecord")
            ...
            modelBuilder.Entity("Prema.ChamaOne.Infrastructure.Models.Transaction", b =>
                {
                    b.HasOne("Prema.ChamaOne.Infrastructure.Models.TransactionEntity", "TransactionEntity")
                        .WithMany("Transactions")
                        .HasForeignKey("fk_transaction_entity_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Prema.ChamaOne.Infrastructure.Models.TransactionEntityType", "TransactionEntityType")
                        .WithMany("Transactions")
                        .HasForeignKey("fk_transaction_entity_type_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Prema.ChamaOne.Infrastructure.Models.TransactionType", "TransactionType")
                        .WithMany("Transactions")
            ...
            modelBuilder.Entity("Prema.ChamaOne.Infrastructure.Models.TransactionEntity", b =>
                {
                    b.HasOne("Prema.ChamaOne.Infrastructure.Models.Contribution", "Contribution")
                        .WithOne("TransactionEntity")
                        .HasForeignKey("Prema.ChamaOne.Infrastructure.Models.TransactionEntity", "fk_contribution_id");

                    b.HasOne("Prema.ChamaOne.Infrastructure.Models.Loan", "Loan")
                        .WithOne("TransactionEntity")
                        .HasForeignKey("Prema.ChamaOne.Infrastructure.Models.TransactionEntity", "fk_loan_id");
