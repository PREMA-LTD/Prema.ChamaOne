...
namespace Prema.ChamaOne.Api.Backend.Migrations
{
    ...
    [Migration("20240725063646_updatedtransaction_addedentityclass1")]
    partial class updatedtransaction_addedentityclass1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Prema.ChamaOne.Api.Backend.Models.Occupation", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Prema.ChamaOne.Api.Backend.Models.SMSFailure", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Prema.ChamaOne.Api.Backend.Models.SMSRecord", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Prema.ChamaOne.Api.Backend.Models.Contribution", b =>
                {
                    b.HasBaseType("Prema.ChamaOne.Api.Backend.Models.TransactionEntity");
            ...
            modelBuilder.Entity("Prema.ChamaOne.Api.Backend.Models.Member", b =>
                {
                    ...
                    b.HasOne("Prema.ChamaOne.Api.Backend.Models.Occupation", "Occupation")
                        .WithMany("Members")
            ...
            modelBuilder.Entity("Prema.ChamaOne.Api.Backend.Models.SMSFailure", b =>
                {
                    b.HasOne("Prema.ChamaOne.Api.Backend.Models.SMSRecord", "SMSRecord")
            ...
            modelBuilder.Entity("Prema.ChamaOne.Api.Backend.Models.Contribution", b =>
                {
                    ...
                    b.HasOne("Prema.ChamaOne.Api.Backend.Models.TransactionEntity", null)
                        .WithOne()
                        .HasForeignKey("Prema.ChamaOne.Api.Backend.Models.Contribution", "id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Prema.ChamaOne.Api.Backend.Models.Loan", b =>
                {
                    ...
                    b.HasOne("Prema.ChamaOne.Api.Backend.Models.TransactionEntity", null)
                        .WithOne()
                        .HasForeignKey("Prema.ChamaOne.Api.Backend.Models.Loan", "id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
